...
public class GameTiga extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        timer = new CountDownTimer(15000, 500) {
            ...
            public void onFinish() {
                ...
                Toast.makeText(GameTiga.this, "Game Over!", Toast.LENGTH_SHORT).show();
    ...
    private void endGame(){
        ...
        Toast.makeText(GameTiga.this, "Failed!", Toast.LENGTH_SHORT).show();
